...
public class CampaignData {
	...
	public int id;
	public AdxQuery[] campaignQueries;// array of queries relvent for the
										// campaign.
	...
	public String toString() {
		return "Campaign ID " + id + ": " + " " + dayStart + "-" + dayEnd + " " + targetSegment + ", reach: "
				+ stats.getTargetedImps() + "/" + reachImps + " pressure:" + timePressure + " pRatio:" + profitRatio
